    ...
    public partial class OpcWindowsService : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            try
            {
                ...
                WriteFile("opc server connected");
                    ...
                    //{
                        ...
                        switch (type)
                        {
                            ...
                            case RequestType.GetListServer:
                                ...
                                var dataGetListServer = new ServerListResponseModel();
                                dataGetListServer.RequestType = RequestType.GetListServer;
                                dataGetListServer.Servers = servers;
                                _sServer.Send(dataGetListServer);
                                break;
                            ...
                            case RequestType.RemoveServer:
                                ...
                                break;
                            default:
                                _sServer.Send(new ErrorResponseModel() { RequestType = RequestType.Error, Message = "Unnownk RequestType: " + type.ToString()});
                                break;
                        }
                    //}
                    //else
